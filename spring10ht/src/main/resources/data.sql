...
insert into BOOKS_COMMENTS(BOOKID, COMMENT_TEXT) values (1, 'Great book');
insert into BOOKS_COMMENTS(BOOKID, COMMENT_TEXT) values (1, 'So-so');
insert into BOOKS_COMMENTS(BOOKID, COMMENT_TEXT) values (2,'Good book');
insert into BOOKS_COMMENTS(BOOKID, COMMENT_TEXT) values (3, 'Nothing special');
